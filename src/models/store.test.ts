...
describe("store", async () => {
  it("store", () => {
    ...
    expect(ctxStore.API.result).toBeTruthy();
    expect(ctxStore.API.result?.totalResults === 2).toBeTruthy();
    expect(ctxStore.APIV.result).toBeTruthy();
    expect(ctxStore.APIV.result?.totalResults === 2).toBeTruthy();
  });
});
